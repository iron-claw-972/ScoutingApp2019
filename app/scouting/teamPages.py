...
def teamPages(number):
    ...
    if(not str(number).isdigit()):
        ...
        return flask.render_template('teamPages.html', THS=THS, TCS=TCS, AHS=AHS, ACS=ACS, HC=HC, CC=CC, CT=CT, W=W, PL=PL, DT=DT, COM=COM, BC=BC, PIC=PIC, HIL=HIL, PHH=PHH, PCH=PCH, CIL=CIL, num=str(number), name=name, website=website, matches=matches)
